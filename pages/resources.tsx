...
const resources = () => {
    ...
    return (
        <>
            <div className="max-w-1120 mx-auto mt-14 lg:mt-28  px-6 lgg1:px-0">
            ...
            <div className="max-w-1440 mx-auto relative lg:h-775 lgg:h-892 mb-16 lg:mb-0">
                <div className="px-6 lgg1:px-0 max-w-1088 w-full lg:absolute right-0">
            ...
            <div className="px-6 lgg1:px-0 max-w-1120 mx-auto mb-16">
