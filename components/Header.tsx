...
const Header = () => {
    return (
        <div className="px-6 lgg1:px-0">
            <div className="max-w-1120 my-0 mx-auto py-24 mdd:flex justify-between font-runda relative">
                ...
                <div className="xxxl:absolute lgg:-right-32">
                    <div className="bg-cover max-w-608 h-512 -mb-98 lg:-mb-0 mx-auto lg:mx-0">
                        <div className="xls:w-80 xxs:w-96 md1:w-608 mdd:w-96 lgg:w-510 xxxl:w-608"></div>
                    </div>
                </div>
            </div>
        </div>
