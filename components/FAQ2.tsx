...
const FAQ2 = ({ data }) => {
  ...
  return (
    <div className=" w-100% px-6 lgg:px-0">
        <div className="py-20 md:py-20 lg:py-28 max-w-544 lg:max-w-1120 my-0 mx-auto lg:flex justify-between w-full">
            <div className="lg:inline-block mb-14 w-72 md:w-full lg:w-80 md:mx-auto lg:mx-0">
                <h2 className=" text-brownLight text-7xl text-left lg:text-8xl uppercase font-body font-bold leading-11 pr-4">frequently asked questions</h2>
            </div>
